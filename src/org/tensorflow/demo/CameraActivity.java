...
//        TextView t = (TextView) findViewById(R.id.textBar);
//        t.setTranslationZ(99);
    ...
    protected void onActivityResult(int reqCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            try {
                ...
                Bitmap bmp_Copy = selectedImage.copy(Bitmap.Config.ARGB_8888,true);
                //ImageReader ir = ImageReader.newInstance(selectedImage.getWidth(), selectedImage.getHeight(), ImageFormat.PRIVATE,1);

                ImageView image_view=(ImageView) findViewById(R.id.image_view);
                image_view.setImageBitmap(bmp_Copy);
                Toast.makeText(getApplicationContext(),bmp_Copy.getHeight()+"   "+bmp_Copy.getWidth(),Toast.LENGTH_LONG).show();
                TensorFlowObjectDetectionAPIModel obj = new TensorFlowObjectDetectionAPIModel();
                //TensorFlowYoloDetector obj=new TensorFlowYoloDetector();
                //List<Classifier.Recognition> results= obj.recognizeImage(bmp_Copy);
